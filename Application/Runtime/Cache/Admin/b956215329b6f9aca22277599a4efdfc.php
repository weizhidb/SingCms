    ...
    <div class="container-fluid" >
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    <li>
                        <i class="fa fa-dashboard"></i>  <a href="/SingCms/admin.php?m=admin&c=menu&a=index">菜单管理</a>
                    </li>
                    <li class="active">
        ...
        <!-- /.row -->
        <div class="row">
            <form action="/SingCms/admin.php" method="get" style="display:none;">
...
<script>
    ...
    var SCOPE = {
        'add_url' : '/SingCms/admin.php?c=menu&a=add',
        'edit_url' : '/SingCms/admin.php?c=menu&a=edit',
        'set_status_url' : '/SingCms/admin.php?c=menu&a=setStatus',
