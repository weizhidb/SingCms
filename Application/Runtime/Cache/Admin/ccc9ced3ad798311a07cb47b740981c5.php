    ...
    <div class="container-fluid" >
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li>
              <i class="fa fa-dashboard"></i>  <a href="/SingCms/admin.php?c=content">新闻管理</a>
            </li>
            <li class="active">
            ...
            <form id="singcms-listorder">
              <table class="table table-bordered table-hover singcms-table">
                ...
                <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <!--<td><input size=4 type='text'  name='listorder[<?php echo ($new["news_id"]); ?>]' value="<?php echo ($new["listorder"]); ?>"/></td>&lt;!&ndash;6.7&ndash;&gt;-->
                    ...
                    <td style="text-align: center;">
                      <img src="<?php echo ($new["thumb"]); ?>" style="height: 50px;width: 50px;">
                    </td>
