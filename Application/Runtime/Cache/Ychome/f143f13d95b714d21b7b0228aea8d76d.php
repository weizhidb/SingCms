    ...
    <div class="am-collapse am-topbar-collapse right" id="doc-topbar-collapse">
      ...
      <div class=" am-topbar-left am-form-inline am-topbar-right" role="search">
        <ul class="am-nav am-nav-pills am-topbar-nav hw-menu">
          <li class="hw-menu-index"><a href="/SingCms/ychome.php?c=Index&a=index">首页</a></li>
          <!--<li><a href="product-show.html">产品展示 </a></li>-->
          <li class="hw-menu-product"><a href="/SingCms/ychome.php?c=Product&a=index">产品展示</a></li>
          <!--<li><a href="service-center.html">服务中心 </a></li>-->
          <li class="hw-menu-news"><a href="/SingCms/ychome.php?c=News&a=index&catid=3">新闻动态 </a></li>
          <li class="hw-menu-customer"><a href="/SingCms/ychome.php?c=Customer&a=index">客户案例 </a></li>
          <li class="hw-menu-about"><a href="/SingCms/ychome.php?c=Aboutus&a=index">关于我们</a></li>
          <li class="hw-menu-zhaoping"><a href="/SingCms/ychome.php?c=Recruit&a=index">招贤纳士 </a></li>
        </ul>
      </div>
...
<div class="toppic">
  <div class="am-container-1">
    ...
    <div class="right toppic-progress">
      <span><a href="/SingCms/ychome.php?c=Index&a=index" class="w-white">首页</a></span>
      <i class=" am-icon-arrow-circle-right w-white"></i>
      <span><a href="/SingCms/ychome.php?c=News&a=index" class="w-white">新闻动态</a></span>
    </div>
  </div>
</div>
...
<div class="am-container-1 news-content-all" style="min-height: 550px;">
  <div class="left am-u-sm-12 am-u-md-8 am-u-lg-9 " style="">
    <div class="list_box">
      <div class="news_list">
        <ul>

          <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><li class="class_news"  attr-id="<?php echo ($new["news_id"]); ?>"><span><?php echo (date("Y-m-d H:i",$new["create_time"])); ?></span><a><?php echo ($new["description"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
      </div><!-- news_list结束 -->
      <ul class="am-pagination" style="display:none;text-align: center;margin-bottom: 30px;margin-top: 30px;">
        <li ><a href="#">&laquo;</a></li>
        <li><a class="prevpage">上一页</a></li>
        <li><a class="current-page"><span class="current-page-span"><?php echo ($currentpage); ?></span>/<span class="current-page-total"><?php echo ($totalpages); ?></span></a></li>
  ...
  <div class="left am-u-sm-12 am-u-md-4 am-u-lg-3" style="
    ">
    <div class="hot-title"><i class=""></i>新闻中心 / News</div>
    <div class="news_type">
      <div class="news_type_content" attr-id="<?php echo ($catId); ?>">
        <ul>
          <li><a href="/SingCms/ychome.php?c=News&a=index&catid=3" class="news_type_content_company">公司新闻</a></li>
          <li><a href="/SingCms/ychome.php?c=News&a=index&catid=4" class="news_type_content_hangye">行业新闻</a></li>
        </ul>
      </div>
    </div><!-- news_type结束 -->
  </div>
...
<script>
  ...
  $(document).ready(function(){
    var catid = $(".news_type_content").attr('attr-id');
//    alert(catid)
    if(catid == 4){
      $(".news_type_content_company").removeClass("select-active");
      $(".news_type_content_hangye").addClass("select-active");
    }else if(catid == 3){
      $(".news_type_content_company").addClass("select-active");
      $(".news_type_content_hangye").removeClass("select-active");
    }
  });


  $(".class_news").click(function(){
...
//    alert($(".current-page-span").text())
//    alert($(".current-page-total").text())
//    if ($(".current-page-span").text() > 1) {
//        var prev = parseInt($(".current-page-total").text())-1;
//      var url = SCOPE.news_url + '&page=' + prev;
//      window.location.href = url;
//    }
  });

    $(".nextpage").click(function () {
//      if ($(".current-page-span").text() < $(".current-page-total").text()) {
//          var next = parseInt($(".current-page-total").text())+1;
//        var url = SCOPE.news_url + '&page=' + next;
//        window.location.href = url;
//      }
  });
  ...
  var SCOPE = {
    'newsinfo_url' : '/SingCms/ychome.php?c=News&a=toinform',
    'news_url' : '/SingCms/ychome.php?c=News&a=index',
  }
</script>
        ...
        <li class="am-u-lg-4 am-u-md-4 am-u-sm-12 ">
            ...
            <div class="part-5-words2">
                <ul class="part-5-words2-ul">
                    <li class="am-u-lg-4 am-u-md-6 am-u-sm-4"><a href="/SingCms/ychome.php?c=Index&a=index">首页</a></li>
                    <li class="am-u-lg-4 am-u-md-6 am-u-sm-4"><a href="/SingCms/ychome.php?c=Product&a=index">产品展示</a></li>
                    <li class="am-u-lg-4 am-u-md-6 am-u-sm-4"><a href="/SingCms/ychome.php?c=News&a=index&catid=3">新闻动态</a></li>
                    <li class="am-u-lg-4 am-u-md-6 am-u-sm-4"><a href="/SingCms/ychome.php?c=Customer&a=index">客户案例</a></li>
                    <li class="am-u-lg-4 am-u-md-6 am-u-sm-4"><a href="/SingCms/ychome.php?c=Aboutus&a=index">关于我们</a></li>
                    <li class="am-u-lg-4 am-u-md-6 am-u-sm-4"><a href="/SingCms/ychome.php?c=Recruit&a=index">招贤纳士</a></li>
                    <div class="clear"></div>
                </ul>
            </div>
        </li>
