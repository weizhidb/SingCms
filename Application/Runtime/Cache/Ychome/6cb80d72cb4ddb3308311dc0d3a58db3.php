...
<div class="toppic">
  <div class="am-container-1">
    <div class="toppic-title left">
      ...
      <span class="toppic-title-span">s</span>
      <p>News Information</p>
    </div>
    <div class="right toppic-progress">
      <span><a href="/SingCms/?m=YcHome&c=Product&a=index" class="w-white">产品展示</a></span>
      <i class=" am-icon-arrow-circle-right w-white"></i>
      <span><a href="" class="w-white">产品详情</a></span>
    </div>
  </div>
</div>
...
<div class="am-container-1 margin-t30">
  <div class="words-title ">
    ...
    <div><?php echo (date("Y-m-d H:i",$product["create_time"])); ?></div>
  </div>
</div>
...
<div class="solution-inform">
  <div class=" solution-inform-content-all">
    <div class="solution-inform-content">
        ...
        <!--<div id="myCarousel" class="carousel slide">-->
          ...
          <!--<div class="carousel-inner">-->
            <!--<div class="item active">-->
              <!--<img src="/SingCms/Public/YcHome//img/inform.png" alt="First slide">-->
            <!--</div>-->
            <!--<div class="item">-->
              <!--<img src="/SingCms/Public/YcHome//img/inform.png" alt="Second slide">-->
            <!--</div>-->
            <!--<div class="item">-->
              <!--<img src="/SingCms/Public/YcHome//img/inform.png" alt="Third slide">-->
            <!--</div>-->
          <!--</div>-->
      ...
      <p class="solution-inform-content-words"><?php echo ($product["product_desc"]); ?>
      </p>
...
<script>
  $('.hw-menu .hw-menu-product').addClass("hw-menu-active");
</script>
